...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="container-xxl">
            <form method="post" action="{{ url('admin/sub-category/update/' . $category['id']) }}"
                    ...
                    <div class="col-xl-12 col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select required name="status" class="form-control" id="crater" data-choices
                                            ...
                                            <option @if ($category['status'] == 1) selected @endif value="1">مفعل
                                            </option>
                                            <option @if ($category['status'] == 0) selected @endif value="0">غير
                                                مفعل</option>
                                        </select>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-0">
                                            ...
                                            <textarea required class="form-control bg-light-subtle tinymce" id="description" rows="7" name="description">{{ $category['description'] }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-3 mb-3 rounded bg-light">
                            <div class="row justify-content-start g-2">
                                ...
                                <div class="col-lg-3">
                                    <a href="{{ url('admin/sub-categories/'.$category['parent_id']) }}"
                                        class="btn btn-danger w-100"> الغاء </a>
                                </div>
